...
<html>
	<head>
		...
		<title>Amit College - Bhubaneswar +3 commerce Category</title>	
        ...
        <link rel="canonical" href="https://amitcollege.org.in/+3cmm_category.php" />
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								...
								<h1 class="text-dark font-weight-bold text-8" style="color:#fff !important;">+3 Sc. & Comm Gallery</h1>
					...
					<div class="row">
						<div class="col">
							<div class="blog-posts">
								...
								<?php	
                                	$imgsql      = ("SELECT * FROM tbl_department_category WHERE dep_category=9 AND status = 1 ");
