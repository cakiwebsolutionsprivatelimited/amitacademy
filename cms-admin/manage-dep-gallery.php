...
$pageName = 'Manage Department Gallery';
            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								switch($q) {
									case "add" : {include_once("files/dep-gallery_add.php"); break;}
									case "edit" : {include_once("files/dep-gallery_edit.php"); break;}
									default:  {include_once("files/dep-gallery_list.php"); break;}
								}?>
                            </div>
                        </div>
