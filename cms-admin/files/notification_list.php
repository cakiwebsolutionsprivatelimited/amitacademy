...
$countRec = $crud->countRec("SELECT COUNT(1) as total FROM tbl_notification");
$res      = $crud->getData($sql);
//print_r($countRec);exit;
?>
<div class="card">
    <div class="row"><div class="col-md-6"><h5 class="card-header"><?php echo $pageName;?></h5></div><div class="col-md-6"><span style="float:right"><a href="<?php echo $curPage;?>?q=add" class="btn btn-success">Add Notification</a></span></div></div>
    <div class="card-body">
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $vals['notification'];?></td>
              ...
              <td><?php echo date('d M Y',strtotime($vals['expiredate']));?></td>
...
<script>
	var actPage = 'NotificationAction.php';
