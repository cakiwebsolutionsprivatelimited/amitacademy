...
$countRec = $crud->countRec("SELECT COUNT(1) as total FROM tbl_result WHERE id = '$id'");
if($countRec['total'] == 0){
    ...
    <div class="card-body">
        <div class="card-body">
        	<form class="form-horizontal" name="frm" action="ResultAction.php" method="post" autocomplete="off" enctype="multipart/form-data">
                             					<input type="hidden" name="act" value="updresult" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="ltitle" class="form-control" id="notification" value="<?php echo $res[0]['title'];?>" required maxlength="250" />
                                                    </div>
