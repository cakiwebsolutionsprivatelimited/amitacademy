...
<html>
	<head>
        ...
        <link rel="canonical" href="https://amitcollege.org.in/msc_category.php" />
...
<div role="main" class="main">
				...
				<section class="page-header page-header-modern bg-color-light-scale-1 page-header-md" style="background-color:#d22523 !important;">
					<div class="container">
						<div class="row">

							<div class="col-md-12 align-self-center p-static order-2 text-center">

								<h1 class="text-dark font-weight-bold text-8" style="color:#000 !important;">M.SC Gallery</h1>
					...
					<div class="row">
						<div class="col">
							<div class="blog-posts">
								...
								<?php	
                                	$imgsql      = ("SELECT * FROM tbl_department_category WHERE dep_category=7 AND status = 1 ");
