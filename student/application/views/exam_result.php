        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title"><?=$examdata[0]['exam_title']?></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-2">
                            <div class="info-box bg-light">
                                <div class="info-box-content">
                                    <span class="info-box-text text-center text-muted">Total Mark</span>
                                    <span class="info-box-number text-center text-muted mb-0"><?php echo $examresult[0]['scored_marks'].'/'.$examresult[0]['total_marks'];?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-2">
                            <div class="info-box bg-light">
                                <div class="info-box-content">
                                    <span class="info-box-text text-center text-muted">Rank</span>
                                    <span class="info-box-number text-center text-muted mb-0"><?php echo $resultrank[0]['rank'];?></span>
                                </div>
                            </div>
                        </div>
                    </div>
